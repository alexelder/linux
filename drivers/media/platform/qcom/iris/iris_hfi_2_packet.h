...
#ifndef _IRIS_HFI_2_PACKET_H_
#define _IRIS_HFI_2_PACKET_H_
...
int iris_hfi_2_packet_sys_init(struct iris_core *core,
			       u8 *pkt, u32 pkt_size);
int iris_hfi_2_packet_image_version(struct iris_core *core,
				    u8 *pkt, u32 pkt_size);
