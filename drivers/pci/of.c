...
void of_pci_make_dev_node(struct pci_dev *pdev)
{
	...
	if (pci_device_to_OF_node(pdev)) {
		...
		/*
		 * For an endpoint device, we still want to add or update
		 * its devicetree "ranges" property.  The new property will
		 * include an an entry for every BAR, mapping BAR offsets
